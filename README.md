...
[![Build Status](https://travis-ci.org/nexbit/peatio.svg?branch=master)](https://travis-ci.org/nexbit/peatio)
[![Telegram Chat](https://cdn.rawgit.com/Patrolavia/telegram-badge/8fe3382b/chat.svg)](https://t.me/peatio)

## [Peatio.tech](https://www.nexbit.io) Introduction
...
and extend it using other microservices such as [Barong](https://www.github.com/nexbit/barong).
...
* [KYC Verification](http://en.wikipedia.org/wiki/Know_your_customer) provided by [Barong](https://www.github.com/nexbit/barong)
...
We suggest you to start using Peatio by installing [Microkube] .
[Microkube](https://github.com/nexbit/microkube) which is based on
...
Follow microkube [README]  for the best Peatio installation experience.

### Local development environment with workbench (DEPRECATED since 2.0):

[Workbench](https://github.com/nexbit/workbench) is legacy way for running Peatio locally.
Probably Workbench support will be removed soon. We advice to use [Microkube] 
which is more lightweight environment.

#### [Barong](https://github.com/nexbit/barong)

Barong is an essential part of nexbit Peatio. It is a KYC OAuth 2.0 provider. Barong replace the KYC, 2FA, Phone verification from legacy Peatio.
...
* [Deploy production cluster with kite] 
...
If you spot a bug, then please raise an issue in our main GitHub project (nexbit/peatio); likewise, if you have developed a cool new feature or improvement in your nexbit Peatio fork, then send us a pull request!
...
you can contact us on [NEXBIT](https://www.nexbit.io).

Contact us by email: [info@nexbit.io]
