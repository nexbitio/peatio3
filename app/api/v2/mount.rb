  ...
  module V2
    class Mount < Grape::API
      ...
      add_swagger_documentation base_path:   File.join(API::Mount::PREFIX, API_VERSION),
                                ...
                                info: {
                                  title:         "Peatio User API #{API_VERSION} developed by NEXBIT.IO",
                                  description:   'API for nPro application stack.',
                                  contact_name:  'https://platform.nexbit.io',
                                  contact_email: 'info@nexbit.io',
                                  contact_url:   'https://platform.nexbit.io',
                                  licence:       'MIT',
